package com.dev.chacha.loans.presentation.installment_loan
...
@Composable
fun AboutInstallmentLoanScreen() {
    Scaffold(
        topBar = {
        ...
        Column(
            ...
            Box(
                ...
                Column(
                    ...
                    Text(
                        text = stringResource(id = R.string.installment_loan_title),
                        style = MaterialTheme.typography.titleLarge
                    )
                    Text(
                        text = stringResource(id = R.string.about_installment_loan_1),
                        style = MaterialTheme.typography.titleSmall
                    )
                    Text(
                        text = stringResource(id = R.string.about_installment_loan_2),
                        style = MaterialTheme.typography.titleSmall
                    )
                    Text(
                        text = stringResource(id = R.string.about_installment_loan_3),
                        style = MaterialTheme.typography.titleSmall
                    )
                    Text(
                        text = stringResource(id = R.string.about_installment_loan_4),
                        style = MaterialTheme.typography.titleSmall
                    )
