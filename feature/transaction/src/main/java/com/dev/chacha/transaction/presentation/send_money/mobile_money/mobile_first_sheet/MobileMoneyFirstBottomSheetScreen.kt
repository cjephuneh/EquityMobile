package com.dev.chacha.transaction.presentation.send_money.mobile_money.mobile_first_sheet
...
@Composable
@Preview
fun MobileMoneyFirstBottomSheetScreen() {
    ...
    Column(
        ...
        Column(
            ...
            AppTopBar(
                ...
                onSearchParamChange = {},
                showSearchBar = true,
                searchHint = "Search for a recipient"
            )
            ...
            MoreVerticalItem(
                ...
                onClick = {
                    isSheetOpen = true
                    currentBottomSheet = TransactionBottomSheetType.SEND_MONEY_OPERATORS
                }
            )
